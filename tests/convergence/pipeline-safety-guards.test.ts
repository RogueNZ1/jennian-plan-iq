...
describe("geometry_status flag at the compose seam", () => {
  ...
  it("geometry-present runs stay byte-identical: field absent", () => {
    const geometry = {
      ...
      measurements: {
        floor_area_m2: 139.4, perimeter_m: 56.2, external_wall_length_m: 56.2,
        internal_wall_length_m: 7, internal_wall_confidence: "medium",
        garage_area_m2: null, alfresco_area_m2: null, stud_height_mm: 2400,
        bounding_box_m: null, room_count: 4, main_room_count: 4, rooms: [],
      },
    } as never;
    const out = composeTakeoff({
      visionTakeoff: minimalVision,
...
function base(over: Partial<QSExportData> = {}): QSExportData {
  return {
    jobNumber: "JM-TEST", clientName: "Test Client", address: "Full Test",
    templateId: null, createdAt: "", floorAreaM2: 139, perimeterLm: 56,
    firstFloorAreaM2: null, studHeightMm: 2400, alfrescoAreaM2: null,
    ...
    email: null, phone: null, jmwNumber: "JM-TEST", planVersion: "1",
    exteriorWallLengthLm: 56, exteriorWallHeightM: 2.4,
