...
function enrichedWith(doors: EnrichedTakeoff["door_counts_auto"]): EnrichedTakeoff {
  ...
  const e = {
    floor_area_m2: f(100),
    garage_area_m2: f(null),
    external_wall_lm: f(40),
    internal_wall_lm: f(null),
    roof_area_m2: f(null),
    alfresco_area_m2: f(0),
    window_count: f(0),
    external_door_count: f(null),
    internal_door_count: f(null),
    bathroom_count: f(null),
    ensuite_count: f(null),
    laundry_count: f(null),
    kitchen_count: f(null),
    ceiling_height_m: f(2.4),
    foundation_type: f(null),
    windows_by_room: f(null),
    windows_schedule: f(null),
    door_breakdown: f(null),
    garage_door_size: f(null),
    external_wall_area_m2: f(null),
    total_area_m2: f(100),
