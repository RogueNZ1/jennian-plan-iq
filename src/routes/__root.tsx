  ...
  head: () => ({
    meta: [
      ...
      { title: "Jennian IQ" },
      {
        name: "description",
        content:
          "Quantity review, plan analysis, and estimating preparation for Jennian Homes Manawatū.",
      },
      ...
      },
      {
        property: "og:image",
        content:
          "https://pub-bb2e103a32db4e198524a2e9ed8f35b4.r2.dev/e6f4cb9b-dd0a-4f3c-a0a0-09fccf206319/id-preview-7928ae3b--24af4814-8129-4c9b-b190-e164c9a02fac.lovable.app-1778375832227.png",
      },
      {
        name: "twitter:image",
        content:
